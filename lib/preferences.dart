...
class Preferences {
  ...
  bool get isShowRateDialogAgain =>
      _instance1.getBool(PREFERENCE_IS_SHOW_RATE_DIALOG_AGAIN) ?? true;

  set isShowRateDialogAgain(bool isShowRateDialogAgain) {
    _instance1.setBool(
        PREFERENCE_IS_SHOW_RATE_DIALOG_AGAIN, isShowRateDialogAgain);
  }
  ...
  int get millisecondsFirstLaunch =>
      _instance1.getInt(PREFERENCE_MILLISECONDS_FIRST_LAUNCH) ??
