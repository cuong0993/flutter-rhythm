...
convert $1.2tmp.png -background "#978faf" -gravity south -extent 2732x2048 $1.3tmp.png
convert $1.3tmp.png -gravity North -pointsize 120 -font Roboto-Condensed-Regular -fill "#1f1929" -annotate +0+50 "$2" $1.4tmp.png