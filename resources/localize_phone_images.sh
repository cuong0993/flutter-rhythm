...
convert $1.2tmp.png -background "#978faf" -gravity south -extent 2208x1242 $1.3tmp.png
convert $1.3tmp.png -gravity North -pointsize 80 -font Roboto-Condensed-Regular -fill "#1f1929" -annotate +0+10 "$2" $1.4tmp.png